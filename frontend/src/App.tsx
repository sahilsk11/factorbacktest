...
export const endpoint = (process.env.NODE_ENV === 'production') ? "https://tgwmxgtk07.execute-api.us-east-1.amazonaws.com/prod" : ("http://localhost:" + (process.env.REACT_APP_API_PORT || 3009));
