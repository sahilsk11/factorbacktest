    ...
    <div className={footerStyles.footer}>
      <div className={footerStyles.footer_text_wrapper}>
        <ul>
          ...
          <li className={appStyles.footer_stat}>Unique Users: {uniqueUsers}</li>
          <li className={appStyles.footer_stat}># Backtests Run: {backtests}</li>
          <li className={appStyles.footer_stat}>Distinct Strategies Tested: {strategies}</li>
          <li className={appStyles.footer_stat}>Made with ❤️ in NYC</li>
        </ul>
      </div>
    </div>
  </>
