...
// Source: internal/calculator/factor_expression.service.go
//
...
import (
	context "context"
	calculator "factorbacktest/internal/calculator"
...
func (m *MockFactorExpressionService) CalculateFactorScores(ctx context.Context, tradingDays []time.Time, tickers []model.Ticker, factorExpression string) (map[time.Time]*calculator.ScoresResultsOnDay, error) {
	m.ctrl.T.Helper()
...
func (m *MockFactorExpressionService) CalculateLatestFactorScores(ctx context.Context, tickers []model.Ticker, factorExpression string) (*calculator.ScoresResultsOnDay, error) {
	...
	ret0, _ := ret[0].(*calculator.ScoresResultsOnDay)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockfactorMetricCalculations) AnnualizedStdevOfDailyReturns(ctx context.Context, pr *data.PriceCache, symbol string, start, end time.Time) (float64, error) {
	m.ctrl.T.Helper()
...
func (m *MockfactorMetricCalculations) Price(pr *data.PriceCache, symbol string, date time.Time) (float64, error) {
	m.ctrl.T.Helper()
...
func (m *MockfactorMetricCalculations) PricePercentChange(pr *data.PriceCache, symbol string, start, end time.Time) (float64, error) {
	m.ctrl.T.Helper()
