...
func (mr *MockAdjustedPriceRepositoryMockRecorder) Get(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdjustedPriceRepositoryMockRecorder) ListTradingDays(start, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
