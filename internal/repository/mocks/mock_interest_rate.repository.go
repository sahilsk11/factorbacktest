...
func (mr *MockInterestRateRepositoryMockRecorder) Add(m, date, tx any) *gomock.Call {
...
func (mr *MockInterestRateRepositoryMockRecorder) GetRatesOnDate(date, tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterestRateRepositoryMockRecorder) GetRatesOnDates(dates, tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
