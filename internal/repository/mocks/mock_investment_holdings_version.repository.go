...
func (mr *MockInvestmentHoldingsVersionRepositoryMockRecorder) Add(tx, ihv interface{}) *gomock.Call {
...
func (mr *MockInvestmentHoldingsVersionRepositoryMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
