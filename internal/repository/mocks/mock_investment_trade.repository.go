...
func (mr *MockInvestmentTradeRepositoryMockRecorder) Add(tx, irt interface{}) *gomock.Call {
...
func (mr *MockInvestmentTradeRepositoryMockRecorder) AddMany(tx, m interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInvestmentTradeRepositoryMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInvestmentTradeRepositoryMockRecorder) List(tx, filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInvestmentTradeRepositoryMockRecorder) Update(tx, m, columns interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
